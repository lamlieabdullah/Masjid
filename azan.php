...
<?php
if(isset($_GET['waktu_solat']))$waktu_solat = $_GET['waktu_solat'];
else $waktu_solat = 'Tidak Diketahui';

if(isset($_GET['tempoh_iqamah']))$tempoh_iqamah = $_GET['tempoh_iqamah'];
else $tempoh_iqamah = 10;

if(isset($_GET['tempoh_solat']))$tempoh_solat = $_GET['tempoh_solat'];
else $tempoh_solat= 15;
...
<body>
  ...
  <h1 class="do-splitflap" id="flip-content">AZAN <?php echo strtoupper($waktu_solat);?></h1>

  <div id="iqamah">IQAMAH</div>
  <div id="counter"></div>

  <script>
  var tempoh_iqamah = <?php echo $tempoh_iqamah*60; ?>;
  ...
  function countdownFinished() {
    //setTimeout(function () {
    window.location.replace("solat.php?tempoh_solat=<?php echo $tempoh_solat; ?>");
    //  }, 1000);
  }
