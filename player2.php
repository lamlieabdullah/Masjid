...
<head>
  ...
  <link rel="stylesheet" media="screen" href="vendor/css3-countdown/css/normalize.css">
...
<input id="id-last-update" type="hidden" name="last-update" value="<?php echo $last_update; ?>">
  ...
  <div class="tarikh-masihi" id="kalendar-masihi">
    <div class="row no-gutters">
      <div class="col-3">
        <div align="left" id="tarikh-masihi">00</div>
      </div>
      <div class="col-9">
  ...
  <div class="tarikh-hijrah" id="kalendar-hijrah">
    <div class="row no-gutters">
      <div class="col-9">
        <div align="right" id="bulan-hijrah">JAMADIL AKHIR</div>
        <div align="right" id="tahun-hijrah">0000</div>
      </div>
      <div class="col-3">
      <div align="right" id="tarikh-hijrah">00</div>
    </div>
    </div>
  </div>
